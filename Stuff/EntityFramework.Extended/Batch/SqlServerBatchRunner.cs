    ...
    public class SqlServerBatchRunner : IBatchRunner
    {
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                FixNullParameters(deleteCommand.Parameters);
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                FixNullParameters(updateCommand.Parameters);
        ...
        private static void FixNullParameters(DbParameterCollection parameters)
        {
