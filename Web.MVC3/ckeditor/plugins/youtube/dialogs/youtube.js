(function () {
    CKEDITOR.dialog.add('youtube',
        function (editor) {
            return {
                title: editor.lang.youtube.title, minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 368 : 350, minHeight: 240,
                ...
                onOk: function () {
                    ...
                    val = $.helpers.querystring("v", val);
                    //val = val.replace(/https?:\/\/(?:www\.)?youtube\.com\/watch\?v\=(.*?)(&.)*/, "$1");
                    var text = '<iframe title="YouTube video player" class="youtube-player" type="text/html" width="480" height="390" src="https://www.youtube.com/embed/'
