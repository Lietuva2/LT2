...
(function () {
    CKEDITOR.plugins.add('MediaEmbed',
    {
        ...
        init: function (editor) {
            var me = this;
            CKEDITOR.dialog.add('MediaEmbedDialog' + editor.name, function () {
                return {
                    ...
                    onOk: function (e) {
                        var content = $(e.sender.parts.contents.$).find('iframe').contents().find('textarea').val();
            ...
            editor.addCommand('MediaEmbed', new CKEDITOR.dialogCommand('MediaEmbedDialog' + editor.name));
