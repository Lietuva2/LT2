...
namespace Web.Helpers {
    public static class UrlHelpers {
        ...
        public static string RouteUrlRaw(this UrlHelper urlHelper, string routeName, string controller = null, string action = null)
        {
            return UrlHelper.GenerateUrl(
                ...
                new RequestContext(urlHelper.RequestContext.HttpContext, new RouteData()),
                false
                );
        }
