...
namespace Lucene.Net.Analysis.Lt
{
    ...
    public sealed class LithuanianStemFilter : TokenFilter
    {

        /**
         * The actual token in the input stream.
         */
        private LithuanianStemmer stemmer = null;
        private Hashtable exclusions = null;

        public LithuanianStemFilter(TokenStream input)
            : base(input)
        {
            stemmer = new LithuanianStemmer();
        }

        public LithuanianStemFilter(TokenStream input, Hashtable exclusiontable)
            : this(input)
        {
